...
parser.add_argument('--hidden_dim_1', type=int, default=2)
parser.add_argument('--hidden_dim_2', type=int, default=2)
parser.add_argument('--epochs', type=int, default=5000)

args = parser.parse_args()

#neptune = neptune.init_run(
#    project="physicsinspired/PINN-RFM-non-analytic",
#    api_token="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiIwNGI4YWI4NS0zODc2LTRmNzAtYjUyZi1mNzEzN#DkwNzdlYmMifQ==",
#)    # your credentials
#neptune["param"] = stringify_unsupported({arg:getattr(args,arg) for arg in vars(args)})
